...
Collects numeric health indicators from the Main Server — Proxmox into a timestamped metrics file. Used as input for quarterly risk scoring, anomaly detection, and capacity prediction.
