...
Photo and video backup application. Runs on the Debian VM at `192.168.178.141:2283`.
...
| Database raw | `dump-databases.sh` → rsync of bind-mount → TrueNAS |
| Photo/video library | Included in PBS VM backup → TrueNAS → Filen Cloud |
